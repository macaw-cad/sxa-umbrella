...
function Validate-RenderingVariantCollectionsForUnexpectedFiles {
    param(
        [string]$Path
    )
...
function Validate-RemoteExistRenderingVariantCollections {
    param(
        $Session,
        $RenderingVariantCollections
    )
...
Export-ModuleMember -Function Validate-RenderingVariantCollectionsForUnexpectedFiles
Export-ModuleMember -Function Validate-RemoteExistRenderingVariantCollections